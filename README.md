# MSCA-HYPE-WoodAnt_Species_and_Hybrid_Assignment
...
#################################################################################################################################
The start and end of steps conducted using sinteractive, an interactive way to analyse data without submitting jobs, is also indicated by hashtags, but fewer ones, so that it is easily recognisable, what is a slurm-script and what conducted using sinteractive:
##############################################
